...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
		...
		// 'app/libs/readmore-js/dist/readmore.min.js', // Берем Magnific Popup
		// 'app/libs/scrollflow/dist/eskju.jquery.scrollflow.min.js', // Берем Magnific Popup
		// 'app/libs/jquery-modal/dist/jquery.modal.min.js' // Берем Magnific Popup
		])
